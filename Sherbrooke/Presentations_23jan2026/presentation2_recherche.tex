  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \begin{tikzpicture}[scale=0.8]
        % Triangle des enjeux
        \node[draw, fill=axe1color!20, minimum width=3cm, minimum height=1cm, rounded corners] (gouv) at (0,3) {\small Gouvernance};
        \node[draw, fill=axe2color!20, minimum width=3cm, minimum height=1cm, rounded corners] (ops) at (-1.5,0.5) {\small Opérations};
        \node[draw, fill=axe3color!20, minimum width=3cm, minimum height=1cm, rounded corners] (perf) at (1.5,0.5) {\small Performance};
        \node[draw, fill=usherbgreen!30, circle, minimum size=1.5cm] (ia) at (0,1.5) {\footnotesize\textbf{IA}};
        \draw[->, thick] (gouv) -- (ia);
        \draw[->, thick] (ops) -- (ia);
        \draw[->, thick] (perf) -- (ia);
      \end{tikzpicture}
...
\begin{frame}{Axe 3 : Cadre d'évaluation de la valeur IA}
  \begin{center}
    \begin{tikzpicture}[scale=0.85]
      % Tableau cadre d'évaluation
      \node[draw, fill=axe3color!20, minimum width=4cm, minimum height=0.8cm] at (0,3) {\textbf{Dimension financière}};
      \node[draw, fill=axe3color!15, minimum width=4cm, minimum height=0.8cm, font=\small] at (0,2.2) {ROI, coûts, productivité};
      
      \node[draw, fill=axe3color!20, minimum width=4cm, minimum height=0.8cm] at (5,3) {\textbf{Dimension organisationnelle}};
      \node[draw, fill=axe3color!15, minimum width=4cm, minimum height=0.8cm, font=\small] at (5,2.2) {Processus, adoption, compétences};
      
      \node[draw, fill=axe3color!20, minimum width=4cm, minimum height=0.8cm] at (0,0.8) {\textbf{Dimension sociétale}};
      \node[draw, fill=axe3color!15, minimum width=4cm, minimum height=0.8cm, font=\small] at (0,0) {Équité, éthique, emploi};
      
      \node[draw, fill=axe3color!20, minimum width=4cm, minimum height=0.8cm] at (5,0.8) {\textbf{Dimension environnementale}};
      \node[draw, fill=axe3color!15, minimum width=4cm, minimum height=0.8cm, font=\small] at (5,0) {Empreinte carbone, ressources};
      
      % Flèche centrale
      \node[draw, fill=white, circle, minimum size=1.5cm] at (2.5,1.5) {\footnotesize\textbf{Valeur IA}};
    \end{tikzpicture}
  \end{center}
