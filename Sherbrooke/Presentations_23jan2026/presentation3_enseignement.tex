...
\begin{frame}{Plan de la présentation}
  ...
  \vspace{1em}
  \begin{center}
    \small\textcolor{immediatgreen}{(I) Immédiat} \hspace{2em} \textcolor{prepareorange}{(P) Avec préparation}
  \end{center}
\end{frame}
  ...
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{block}{Le projet qui a tout changé}
        ...
        \vspace{0.5em}
        Un groupe d'étudiants décroche un partenariat avec une \emphvert{clinique médicale} pour analyser ses données patients.
    ...
    \begin{column}{0.48\textwidth}
      \begin{alertblock}{Innovation pédagogique}
        ...
        \begin{itemize}
          ...
          \item Usage réfléchi des LLM comme co-pilotes
        \end{itemize}
        
        \vspace{0.2em}
        
        {\scriptsize \textit{Encadré : citation des prompts, journal de travail}}
      \end{alertblock}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (I) Immédiat}
        \begin{itemize}
          ...
          \item[\textcolor{immediatgreen}{I}] \textbf{GTA411} Gestion de projets techno.
          \item[\textcolor{immediatgreen}{I}] \textbf{GTA431} Manipulation des données
          \item[\textcolor{immediatgreen}{I}] \textbf{GTA531} Transformation numérique
          \item[\textcolor{immediatgreen}{I}] \textbf{GTA631} Sécurité de l'information
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (P) Préparation}
        \begin{itemize}
          \item[\textcolor{prepareorange}{P}] \textbf{GTA421} Progiciels intégrés (ERP)
          \item[\textcolor{prepareorange}{P}] \textbf{GTA511} Intelligence géospatiale
          \item[\textcolor{prepareorange}{P}] \textbf{GTA621} Expérience utilisateur
        \end{itemize}
      \end{block}
      ...
      \begin{alertblock}{Bilan GTA}
        \centering
        \textbf{7 cours (I)} sur 10 cours clés
        
        \vspace{0.3em}
        
        {\small Versatilité pour couvrir la majorité du cheminement}
      \end{alertblock}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{M. Sc. -- Gestion du commerce électronique}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (I) Immédiat}
        \begin{itemize}
          \item[\textcolor{immediatgreen}{I}] \textbf{GCE802} Fondements e-commerce
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (P) Préparation}
        \begin{itemize}
          ...
          \item[\textcolor{prepareorange}{P}] \textbf{GCE831} Projet sites Web
          \item[\textcolor{prepareorange}{P}] \textbf{GCE842} Optimisation UX
          \item[\textcolor{prepareorange}{P}] \textbf{MAR839} Marketing numérique
        \end{itemize}
      \end{block}
...
\begin{frame}{M. Sc. -- Stratégie de l'intelligence d'affaires (SIA)}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (I) Immédiat -- 9 cours}
        \begin{itemize}
          ...
          \item[\textcolor{immediatgreen}{I}] \textbf{MQG812} Forage de données
          \item[\textcolor{immediatgreen}{I}] \textbf{MQG813} Stats décisionnelles avancées
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (P) Préparation -- 3 cours}
        \begin{itemize}
          \item[\textcolor{prepareorange}{P}] \textbf{GIS805} Analyse OLAP/cubes
          \item[\textcolor{prepareorange}{P}] \textbf{GIS806} Entrepôts de données
          \item[\textcolor{prepareorange}{P}] \textbf{GIS808} Intelligence géospatiale
        \end{itemize}
      \end{block}
    ...
    \begin{column}{0.42\textwidth}
      \begin{alertblock}{Valeur ajoutée}
        \begin{itemize}
          ...
          \item Expérience terrain (Bell, Novacap)
        \end{itemize}
      \end{alertblock}
...
\begin{frame}{Synthèse : Capacité d'enseignement}
  \begin{center}
    ...
    \begin{tabular}{l|c|c|c}
      ...
      \hline
      \rowcolor{ushervertclair}
      B.A.A. -- GTA & \textcolor{immediatgreen}{\textbf{7}} & \textcolor{prepareorange}{3} & 10 \\
      \hline
      M. Sc. -- Commerce élec. & \textcolor{immediatgreen}{\textbf{5}} & \textcolor{prepareorange}{5} & 10 \\
      \hline
      \rowcolor{ushervertclair}
      M. Sc. -- SIA & \textcolor{immediatgreen}{\textbf{9}} & \textcolor{prepareorange}{3} & 12 \\
      \hline
      Microprog. 3\textsuperscript{e} cycle IA & \textcolor{immediatgreen}{\textbf{5}} & \textcolor{prepareorange}{0} & 5 \\
      \hline
      \rowcolor{usheror!20}
      \textbf{TOTAL} & \textcolor{immediatgreen}{\textbf{26}} & \textcolor{prepareorange}{11} & \textbf{37} \\
    \end{tabular}
  \end{center}
  ...
  \begin{center}
    \emphvert{26 cours prêts immédiatement} -- mais mon objectif : \textbf{2--3 cours signature}\\[0.3em]
  ...
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      \begin{enumerate}
        ...
        {\small 26 cours (I), 4 programmes, $\sim$15 étudiants gradués}
        \vspace{0.25em}
