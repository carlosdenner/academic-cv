    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (I) Immédiat}
        \begin{itemize}
          ...
          \item[\textcolor{immediatgreen}{I}] \textbf{SDG312} Analytique de données
        \end{itemize}
      \end{block}
    \end{column}
    \begin{column}{0.48\textwidth}
      ...
      \begin{alertblock}{Bilan GTA}
        \centering
        \textbf{5 cours (I)} sur 7 cours ciblés
...
\begin{frame}{M. Sc. -- Stratégie de l'intelligence d'affaires (SIA)}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Cours en (I) Immédiat -- 6 cours}
        \begin{itemize}
...
\begin{frame}{Synthèse : Capacité d'enseignement}
  \begin{center}
    ...
    \begin{tabular}{l|c|c|c}
      ...
      \hline
      \rowcolor{ushervertclair}
      B.A.A. -- GTA & \textcolor{immediatgreen}{\textbf{5}} & \textcolor{prepareorange}{2} & 7 \\
      \hline
      M. Sc. -- Commerce élec. & \textcolor{immediatgreen}{\textbf{4}} & \textcolor{prepareorange}{3} & 7 \\
      \hline
      \rowcolor{ushervertclair}
      M. Sc. -- SIA & \textcolor{immediatgreen}{\textbf{6}} & \textcolor{prepareorange}{3} & 9 \\
      \hline
